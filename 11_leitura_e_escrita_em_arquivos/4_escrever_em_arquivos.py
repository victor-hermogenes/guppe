...
# OBS: Ao abrir um arquivo para escrita, o arquivo é criado no OS.

Para escrevermos dados em um arquivo, após abrir ele, utilizamos a função write()..
Esta função somente recebe string como parâmetro, caso contrário teremos um TypeError

Abrindo um arquivo para escrita com o modo 'w', se o arquivo não existir, será criado,
caso ele já exista, será substituído com novos dados. Dessa forma, todo o conteúdo no
