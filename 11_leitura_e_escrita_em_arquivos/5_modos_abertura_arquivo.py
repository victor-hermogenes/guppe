...
x -> Abre para escrita somente se o arquivo não existir. Caso o arquivo exista, gera FileExistitsError
...
https://docs.python.or/3/library/functions.html#open
...
with open('frutas.txt', 'a') as arquivo:
    while True:
        fruta = input('Informa uma fruta ou sair: ')
        if fruta != 'sair':
            arquivo.write(fruta)
            arquivo.write('\n')
        else:
