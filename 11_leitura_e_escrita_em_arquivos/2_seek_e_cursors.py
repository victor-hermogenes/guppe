...
# seek() -> É utilizada para movimentar o cursor pelo arquivo. Ela recebe um parâmetro que indica onde queremos
# colocar o cursor.

# Movimentando o cursor pelo arquivo coma função seek() -> Procurar
...
# readlines() -> Transforma linhas em lista

linhas = arquivo.readlines()
print(len(linhas))

OBS: Quando abrimos um arquivo com a função open() é criada uma conexão entre o arquivo no disco do computador
e o noso programa. Essa conexão é chamada de streaming. Ao finalizar os trabalhos com o arquivo, devemos fechar essa
...
# 3 - Fechar o arquivo;
arquivo.close()    # True - Verifica se o arquivo está aberto ou fechado
