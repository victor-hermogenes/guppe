...
"""
produto = 2 * 3 * 6 * 8 -> 288
ou seja, a multiplicação dos valores
"""

# mathisqrt - retorna a parte inteira da raiz quadrada de um número
...
# math.dist - retorna a distância euclidiana entre dois pontos, sendo 3D ou 2d
...
# math.hypot - retorna a hipotenusa, ou norma Eculidiana
