...
- Decorators envolvem ouytras funções e aprimoram seus comportamentos;
...
def saudacao():
    print('Seja bem-vindo(a) à Geek Universitu')
...
# Decorators com Syntax Suga (Açúcar Sintático)
