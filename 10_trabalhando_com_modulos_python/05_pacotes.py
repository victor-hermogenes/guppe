...
Modulo -> É apenas um arquivo Python que pode ter diversas dunções para utilizarmos;
...
Nas versões do Python 3.x, não é obrigatória a utilização deste arquivo, mas normalmente ainda é utilizado para
