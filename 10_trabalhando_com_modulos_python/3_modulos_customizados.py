...
Como módulo Python nada mais são do que arquivos Pythn, então todos os arquivos que criamos neste curso
são módulos Python prontospara serem utilizados.
...
# Estamos acessando e impprimindo uma variável contida no módulo
print(fcp.lista)
