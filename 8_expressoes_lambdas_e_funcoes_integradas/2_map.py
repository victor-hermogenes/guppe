...
cidades = [('Berlim', 29), ('Cairo', 36), ('Buenos Aires', 19), ('Los Angeles', 26), ('Tokio', 26), ('Nova York', 28),
           ('Londres', 22)]
...
print(list(map(lambda celsius_para_f: (celsius_para_f[0], (9/5) * celsius_para_f[1] + 32), cidades)))
