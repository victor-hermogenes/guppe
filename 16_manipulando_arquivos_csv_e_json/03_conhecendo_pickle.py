...
A função do Picle é realizar o seguinte processo:
...
shiro = Gato('Shiro')
graveto = Cachorro('Graveto')

with open('animais.pickle', 'wb') as arquivo:
    pickle.dump((shiro, graveto), arquivo)
...
with open('animais.pickle', 'rb') as arquivo:
    ...
    print(f'O gato chamase {gato.nome}')
    gato.mia()
    print(f'O tipo do gato é {type(Gato)}')

    print(f' O chachorro chama-se {cachorro.nome}')
    cachorro.late()
